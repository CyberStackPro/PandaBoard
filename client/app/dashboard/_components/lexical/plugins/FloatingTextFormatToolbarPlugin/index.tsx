import { getDOMRangeRect } from "@/lib/utils/lexical/getDOMRangeRect";
import { setFloatingElemPosition } from "@/lib/utils/lexical/setFloatingElemPosition";
import {
  $getSelection,
  $isParagraphNode,
  $isRangeSelection,
...
function TextFormatFloatingToolbar({
  ...
  function mouseMoveListener(e: MouseEvent) {
    if (
      (popupCharStylesEditorRef?.current && e.buttons === 1) ||
      e.buttons === 3
    ) {
  ...
  }, [$updateTextFormatFloatingToolbar, editor, anchorElem]);
